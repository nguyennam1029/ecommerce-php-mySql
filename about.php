      ...
      <div class="container">
        ...
        <div class="stats-container">
          <div class="stat-item">
            ...
            <div class="stat-description">Sellers active on our site</div>
          </div>
          <div class="stat-item stat-item-highlight">
            ...
            <div class="stat-description active">Monthly Product Sale</div>
          </div>
          <div class="stat-item">
            <div class="stat-icon">
            ...
            <div class="stat-description">Customers active on our site</div>
          </div>
          <div class="stat-item">
            <div class="stat-icon">
            ...
            <div class="stat-description">Annual gross sale on our site</div>
          </div>
        </div>
        <!-- Swiper -->
              ...
              <div class="team-member">
                ...
                <div class="team-member-content">
                  ...
                  <div class="social-icons">
                    <a href="#"
                      ><img
                        src="./image/icons/icon-instagram.png"
                        alt="Twitter"
                    /></a>
                    <a href="#"
                      ><img
                        src="./image/icons/Icon-Twitter.png"
                        alt="Instagram"
                    /></a>
                    <a href="#"
                      ><img
                        src="./image/icons/Icon-Linkedin.png"
                        alt="LinkedIn"
                    /></a>
                  </div>
                </div>
