 ...
 <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
   ...
   <?php
    ...
    ?>
     ...
     <div class="grid grid-cols-8 border-t border-stroke px-1 py-4.5 dark:border-strokedark sm:grid-cols-8 md:px-6 2xl:px-7.5">
       <div class="col-span-3 flex items-center">
       ...
       <div class="col-span-1 flex items-center  gap-4">
         <p class="text-sm font-medium text-black dark:text-white text-center ml-6">
       ...
       <div class="col-span-1 flex items-center gap-4">
         ...
         <?php
          if ($row['soluong'] > 0) {
            echo '<span class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-[#00DF80] text-white">Còn hàng</span>';
          } else {
            echo '<span class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-[#FFD21E] text-gray-800">Hết hàng</span>';
          }
          ?>
       </div>
       <div class="col-span-1 flex items-center">
         ...
         <div class="flex items-center space-x-3.5">
           ...
           <a href="javascript:void(0);" onclick="confirmDelete(<?php echo $row['id_sanpham']; ?>)">
             <svg class="fill-current" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
           ...
           <a href="?action=quanlisanpham&query=sua&idsanpham=<?php echo $row['id_sanpham'] ?>">
 ...
 <script>
   function confirmDelete(id) {
     Swal.fire({
       ...
       text: "Sản phẩm này sẽ không thể khôi phục được!",
       icon: 'warning',
       ...
       if (result.isConfirmed) {
         window.location.href = 'modules/quanlisanpham/xuli.php?idsanpham=' + id;
       }
     });
   }
 </script>