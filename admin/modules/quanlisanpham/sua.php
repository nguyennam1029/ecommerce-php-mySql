            ...
            ?>
             <form method="POST" action="modules/quanlisanpham/xuli.php?idsanpham=<?php echo $row['id_sanpham'] ?>" enctype="multipart/form-data">
                 ...
                 <div class="flex items-center justify-center gap-10 mt-4">
                     ...
                     <button name="suasanpham" type="submit" class="flex items-center  px-5 py-2.5  text-sm font-medium text-center text-white bg-[#0083ff] rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                         Cập nhật
                     </button>
                     <a href="index.php?action=quanlisanpham&query=them" class="py-2.5 px-5  text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">Quay lại</a>
                 </div>
             </form>
         <?php
            }
