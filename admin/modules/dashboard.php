  <div
        ...
        >
          <!-- Card Item Start -->
          <div
            class="rounded-sm border border-stroke p-3 shadow-lg bg-white px-7.5 py-6"
          >
            <div
          ...
          <!-- Card Item Start -->
          <div
            class="p-3 shadow-lg rounded-sm border border-stroke bg-white px-7.5 py-6 p-3 shadow-lg"
          >
            <div
              class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4"
            >
          ...
          <!-- Card Item Start -->
          <div
            class="p-3 shadow-lg rounded-sm border border-stroke bg-white px-7.5 py-6"
          >
            <div
              class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4"
            >
          ...
          <!-- Card Item Start -->
          <div
            class="rounded-sm border border-stroke bg-white px-7.5 py-6 p-3 shadow-lg"
          >
            <div
              class="flex h-11.5 w-11.5 items-center justify-center rounded-full bg-meta-2 dark:bg-meta-4"
            >
        ...
        <h2 class="my-4 font-bold text-xl">Bản đồ thống kê</h2>
