...
CREATE TABLE `tbl_sanpham` (
  ...
  `tomtat` tinytext COLLATE utf8mb4_general_ci NOT NULL,
...
--
ALTER TABLE `tbl_cart`
  MODIFY `id_cart` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `tbl_sanpham`
  MODIFY `id_sanpham` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
COMMIT;
